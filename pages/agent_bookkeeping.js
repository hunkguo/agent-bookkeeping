          ...
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="flex flex-wrap">
              <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-800">
                ...
                <Link className="text-indigo-400 inline-flex items-center">Learn More
            ...
            <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" control-id="ControlID-84">Button</button>
          </div>
        </section>
        <Footer/>
        </>
