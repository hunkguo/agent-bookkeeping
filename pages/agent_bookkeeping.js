    ...
    return (
        ...
        <section class="text-gray-400 body-font bg-gray-900">
          <div class="container px-5 py-24 mx-auto">
            ...
            <button class="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" control-id="ControlID-84">Button</button>
          </div>
        </section>
        <Footer/>
        </>
